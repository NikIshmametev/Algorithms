...
public class LineSegment {
    ...
    public LineSegment(Point p, Point q) {
        if (p == null || q == null) {
            throw new NullPointerException("argument to LineSegment constructor is null");
        }
        if (p.equals(q)) {
            throw new NullPointerException("both arguments to LineSegment constructor are the same point: " + p);
        }
        this.p = p;
        this.q = q;
    }
